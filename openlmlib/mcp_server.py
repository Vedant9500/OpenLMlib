...
def help_library(tool_name: Optional[str] = None) -> dict:
    ...
    collab_tools_summary = {
        ...
        "get_co_scientist_scope_policy": "Get Phase 0 Co-Scientist scope and safety policy for hypothesis generation or multi-agent research.",
        "screen_co_scientist_scope": "Screen a proposed Co-Scientist run before hypothesis generation, verification, or linked sessions.",
        "get_hypothesis_packet_schema": "Get the Co-Scientist hypothesis packet schema for generation-to-verification handoff.",
        "get_evidence_quality_rubric": "Get Co-Scientist support/refute/neutral evidence labels and citation quality rubric.",
        "verify_co_scientist_citations": "Verify Co-Scientist citations before hypothesis verification or final report export.",
        "validate_hypothesis_packet": "Validate a Co-Scientist hypothesis packet before saving or sending it to verification.",
        "create_co_scientist_run": "Create linked Co-Scientist generation and independent verification sessions for multi-agent research.",
        ...
        "start_hypothesis_verification": "Send selected hypotheses to the independent verification session without copying the generation transcript.",
        "submit_verification": "Persist a verification report for one Co-Scientist hypothesis.",
        "get_co_scientist_report": "Inspect synthesized Co-Scientist run state, selected hypotheses, verification reports, and readiness.",
        "create_co_scientist_final_report": "Create a final Co-Scientist report artifact and compact run summaries after verification.",
    ...
    memory_tools = {
        ...
        "query_memory": "Adaptive auto-expanding retriever for memory. REPLACES search_memory.",
        "search_memory": "[DEPRECATED] Layer 1: Lightweight search of memory index (~75 tokens/result).",
        "memory_timeline": "[DEPRECATED] Layer 2: Get chronological context for memory IDs (~200 tokens/result).",
        "get_observations": "[DEPRECATED] Layer 3: Get full details for specific memory IDs (~750 tokens/result).",
    ...
    return {
        ...
        "categories": {
            "Core Library Tools": {
                "description": "Manage findings in the OpenLMlib knowledge base (17 tools including composite and convenience tools)",
                "tools": {name: info["description"] for name, info in core_tools.items()},
            },
            "Memory Injection Tools": {
                "description": "Lifecycle-based memory management with adaptive retrieval and retroactive git ingestion (11 tools)",
                "tools": memory_tools,
